...
1. A friendly interface. In [`remake`](https://github.com/richfitz/remake), the user must manually write a [YAML](https://github.com/richfitz/remake/blob/master/doc/remake.yml) configuration file to arrange the steps of a workflow, which leads to some of the same scalability problems as [Make](https://www.gnu.org/software/make/). [`drake`](https://github.com/ropensci/drake)'s [domain-specific language](https://ropenscilabs.github.io/drake-manual/plans.html#large-plans) easily generates workflows at scale.
