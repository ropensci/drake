...
The following resources explain what `drake` does an how it works. The [`learndrake`](https://github.com/wlandau/learndrake) workshop devotes particular attention to `drake`'s mental model.
...
- [Miles McBain](https://github.com/MilesMcBain)'s [excellent blog post](https://milesmcbain.xyz/the-drake-post/) explains the practical issues {drake} solves for most projects, how to set up a project as quickly and painlessly as possible, and overcome common obstacles.
