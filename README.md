...
Thanks also to [Kirill M&uuml;ller](https://github.com/krlmlr), [Daniel Falster](https://github.com/dfalster), and [Henrik Bengtsson](https://github.com/HenrikBengtsson). They contributed code patches and enhancement ideas to my [parallelRemake](https://github.com/wlandau/parallelRemake) and [remakeGenerator](https://github.com/wlandau/remakeGenerator) packages, which I have now subsumed into drake.
