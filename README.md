...
manual](https://ropenscilabs.github.io/drake-manual/) but may have more
bugs.
...
If you are installing the current CRAN version (5.2.1), you may
encounter an error due to
[`CodeDepends`](https://github.com/duncantl/CodeDepends) (ref:
[duncantl/CodeDepends\#30](https://github.com/duncantl/CodeDepends/issues/30),
[duncantl/CodeDepends\#34](https://github.com/duncantl/CodeDepends/issues/34)).
...
This is because `drake` 5.2.1 depends on
[`CodeDepends`](https://github.com/duncantl/CodeDepends), which depends
on
[`graph`](https://www.bioconductor.org/packages/release/bioc/html/graph.html),
which is not on [CRAN](https://cran.r-project.org). You have two
possible solutions.

1.  Install the development version with
    `devtools::install_github("ropensci/drake")`
2.  Install
    [`graph`](https://www.bioconductor.org/packages/release/bioc/html/graph.html)
    from [Bioconductor](https://www.bioconductor.org) and proceed with
    the CRAN version of `drake`.
