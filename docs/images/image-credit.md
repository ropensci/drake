...
- The [diagram of the typical Tidyverse workflow](https://github.com/ropensci/drake/blob/master/images/tidydag.png) is from [Kirill Müller](https://github.com/krlmlr)'s [`drake` pitch slides](krlmlr.github.io/drake-pitch).
