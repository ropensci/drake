...
- The videos embedded in the [parallel computing vignette](https://ropensci.github.io/drake/articles/parallelism.html) were created with [PowToon](https://www.powtoon.com) and are used in a manner explicitly permitted in the [PowToon Terms and Conditions](https://www.powtoon.com/terms-and-conditions/). See the section on presentations for details.
