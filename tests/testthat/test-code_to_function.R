...
test_with_dir(
  "Scripts are evaluated into function that returns a time and
  file path", {
...
test_with_dir(
  "Returned functions include only the scripts lines that need to
  be evaluated", {
...
test_with_dir(
  "Returned functions include only the scripts lines that need
...
test_with_dir(
  "drake tracks and updates for scripted functions", {
...
test_with_dir(
  "drake tracks and updates for Rmarkdown files that behave
  like scripts", {
