...
#' @title Function package_dependency_version
#' @export
...
#' of it or not.
#' @examples
#' package_dependency_version("base")
#' package_dependency_version("stats")
#' package_dependency_version("package:stats")
#' \dontrun{
#' load_basic_example()
#' plot_graph(my_plan) # Hover over the package nodes on the left.
#' }
package_dependency_version <- function(x){
  pkg <- sans_package(x)
