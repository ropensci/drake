...
drake_tip = function(){
  tips = c(
    "New functions: a MUCH IMPROVED plot_graph(), build_times(), load_basic_example(), outdated(), missed(), deps(), dataframes_graph(), max_useful_jobs(), and shell_file().",
