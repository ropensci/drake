...
#' \code{\link{plan}}. 
#' @param targets character string, names of targets to
#' keep in the cache. All dependencies are kept too.
#' @param envir environment to use, same as in \code{\link{run}()}.
#' This is where your imported objects should have come from.
