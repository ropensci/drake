...
#'
#' @param graph An `config$graph` object from an existing `drake_config()`.
...
#'
#' @param spec `config$spec` from an existing `drake_config()`.
#'   Supplying a pre-built workflow specification to this argument
#'   could save time in some cases.
#'
#' @param layout Deprecated. Use `spec` instead.
#'
