...
bdg_prepare_imports <- function(args){
  ...
  within(args, {
    console_preprocess(text = "analyze environment", config = args)
...
bdg_analyze_triggers <- function(args){
  ...
  within(args, {
    ...
    if ("trigger" %in% colnames(plan)){
      console_preprocess(text = "analyze triggers", config = args)
...
bdg_create_edges <- function(args){
  ...
  within(args, {
    console_preprocess(text = "construct graph edges", config = args)
...
bdg_create_attributes <- function(args){
  ...
  within(args, {
    console_preprocess(text = "construct vertex attributes", config = args)
...
bdg_create_graph <- function(args){
  ...
  with(args, {
    console_preprocess(text = "construct dependency graph", config = args)
