...
- Deprecate many functions that should never have been used to users, including `analysis_wildcard()`, `cache_namespaces()`, `cache_path()`, `check_plan()`, `dataset_wildcard()`, `drake_meta()`, `process_import()`, `drake_palette()`, `drake_tip()`, `in_progress()`, `recover_cache()`, `target_namespaces()`.
