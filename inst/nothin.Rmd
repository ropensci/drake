...
```{r}
drake::vis_drake_graph(config, clusters = unique_stems, group = "cluster_id", hover = FALSE, on_select_col = "link", on_select = TRUE)
```
...
drake::vis_drake_graph(config, clusters = unique_stems, group = "cluster_id", hover = FALSE, on_select_col = "link", on_select = alert_behaviour())
```
