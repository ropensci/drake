...
As for the implementation, you can choose from multiple built-in parallel backends, including `parLapply()`, `mclapply()`, [`Makefiles`](https://www.gnu.org/software/make/), and the staggering array of backends available throught the [future](https://github.com/HenrikBengtsson/future) and [future.batchtools](https://github.com/HenrikBengtsson/future.batchtools) packages. Please see the [parallelism vignette](https://github.com/wlandau-lilly/drake/blob/master/vignettes/parallelism.Rmd) for details.
