...
<img src="https://cdn.rawgit.com/ropensci/drake/301ec7c3/images/infographic.svg" alt="infographic" align="center" style = "border: none; float: center;">

This tutorial is a recommended starting place for learning how to use `drake`. It is the abridged version of the [basic example vignette](https://github.com/ropensci/drake/blob/master/vignettes/example-basic.Rmd). For more information, see the [documentation website](https://ropensci.github.io/drake/), which includes the [rendered online version of the basic example vignette](https://ropensci.github.io/drake/articles/example-basic.html).
...
- `basic`: A tiny, minimal example with the `mtcars` dataset to demonstrate how to use `drake`. Use `load_basic_example()` to set up the project in your workspace. The [basic example vignette](https://github.com/ropensci/drake/blob/master/vignettes/example-basic.Rmd) is a parallel walkthrough of the same example.
