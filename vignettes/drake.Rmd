...
This tutorial is a recommended starting place for learning how to use `drake`. It is the abridged version of the [basic example vignette](https://github.com/ropensci/drake/blob/master/vignettes/example-basic.Rmd). See [this section of the README](https://github.com/ropensci/drake/blob/master/README.md#documentation) for a high-level overview of the available documentation.
