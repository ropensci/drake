...
Similarly to [Make](https://www.gnu.org/software/make/), drake arranges the intermediate steps of your workflow in a network. That way, you can run independent steps in parallel. For example, consider the network graph of the basic example.
