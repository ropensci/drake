...
[Drake's README](https://github.com/wlandau-lilly/drake/blob/master/README.md) has installation instructions and pointers to useful functions. There are also [several specialized vignettes](https://github.com/wlandau-lilly/drake/tree/master/vignettes), which are also [rendered on CRAN](https://cran.r-project.org/package=drake/vignettes/).
...
Today, there is a [whole ecosystem of pipeline toolkits](https://github.com/pditommaso/awesome-pipeline), mostly written in Python. Of all the toolkits in the list, [Rich FitzJohn](http://richfitz.github.io/)'s [remake package](https://github.com/richfitz/remake) is by far the most important for `drake`. `Drake` stands squarely on the shoulders of [remake](https://github.com/richfitz/remake), borrowing the funtamental concepts and extending them in a fresh implementation with a convenient interface and high-performance computing.
