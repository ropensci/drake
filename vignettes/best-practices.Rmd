...
<iframe
src = "https://cdn.rawgit.com/wlandau-lilly/drake/738a26e8/images/good-commands.html"
...
<iframe
src = "https://cdn.rawgit.com/wlandau-lilly/drake/738a26e8/images/bad-commands.html"
width = "100%" height = "600px" allowtransparency="true"
style="border: none; box-shadow: none">
</iframe>
...
2. In `make(bad_plan, jobs = 2)`, `drake` will try to build `my_data` and `my_analysis` at the same time even though `my_data` must be built first.
