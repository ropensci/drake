...
library(ggplot2)
ggplot(data.frame(time = time / 3600, jobs = ordered(1:15), group = 1)) +
...
But why 7 jobs? From the dependency graph, the column of 8 targets makes it seem like there would be a speed improvement from 7 jobs to 8.
