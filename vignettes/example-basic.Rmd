...
For your `knitr` reports, use `knitr_input()` in your commands so that `report.Rmd` is a dependency and targets loaded with `loadd()` and `readd()` in active code chunks are also dependencies. Use `file_output()` to tell `drake` that the target is a file output. If the file is an output, you do not need to name the target. The target name will be the name of the output file in quotes.
...
<iframe
src = "https://cdn.rawgit.com/ropensci/drake/301ec7c3/images/built.html"
width = "100%" height = "600px" allowtransparency="true"
style="border: none; box-shadow: none">
</iframe>
...
<iframe
src = "https://cdn.rawgit.com/ropensci/drake/301ec7c3/images/reg2.html"
width = "100%" height = "600px" allowtransparency="true"
style="border: none; box-shadow: none">
</iframe>
...
1. Files declared with `file_input()` inside your commands or custom functions.
1. `knitr` reports declared with `knitr_input()` in your commands, along with any targets explicitly loaded in active code chunks with `loadd()` or `readd()`. Do not use `knitr_input()` inside your imported functions.
1. Files declared with `file_output()` in your commands. Do not use `file_output()` inside your imported functions.
