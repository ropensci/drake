...
The [storage vignette](https://github.com/wlandau-lilly/drake/blob/master/vignettes/storage.Rmd) describes how storage works in `drake`, particularly hashing and custom caches. Please do not try to change the short hash algorithm of an existing cache, and beware in-memory caches for distributed computing and persistent projects.
