...
Use the `tracked()` function to list which objects, functions, files, targets, etc. are reporducibly tracked. Drake is not perfect, and it can miss dependencies in some edge cases.
