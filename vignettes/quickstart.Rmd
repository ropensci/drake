...
subtitle: "A thorough walk through drake's basic example"
...
This vignette is a quickstart guide that relies on `drake`'s basic example. It sets up the project and runs it repeatedly to demonstrate `drake`'s most important functionality.
