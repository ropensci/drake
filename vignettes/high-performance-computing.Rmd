...
That particular recipe fails on Windows, so just be sure to use a recipe command compatible with your platform.
...
Only attempt the following on a non-Windows platform.

```{r examplerecipesnowindows, eval = FALSE}
make(my_plan, parallelism = "Makefile", jobs = 4,
  recipe_command = "R -e 'R_RECIPE' -q")
make(my_plan, parallelism = "Makefile", jobs = 4,
